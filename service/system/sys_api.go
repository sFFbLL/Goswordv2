...
func (apiService *ApiService) CreateApi(api system.SysApi) (err error) {
	...
	return global.GSD_DB.Create(&api).Error
}
...
func (apiService *ApiService) DeleteApi(api system.SysApi) (err error) {
	err = global.GSD_DB.Delete(&api).Error
	CasbinServiceApp.ClearCasbin(1, api.Path, api.Method)
	return err
}

// GetAPIInfoList @author: [chenguanglan](https://github.com/sFFbLL)
...
func (apiService *ApiService) GetAPIInfoList(api system.SysApi, info request.PageInfo, order string, desc bool) (err error, list interface{}, total int64) {
	...
	db := global.GSD_DB.Model(&system.SysApi{})
...
func (apiService *ApiService) GetAllApis() (err error, apis []system.SysApi) {
	err = global.GSD_DB.Find(&apis).Error
	return
}
...
func (apiService *ApiService) GetApiById(id uint) (err error, api system.SysApi) {
	err = global.GSD_DB.Where("id = ?", id).First(&api).Error
	return
}

// UpdateApi @author: [chenguanglan](https://github.com/sFFbLL)
//@function: UpdateApi
...
func (apiService *ApiService) UpdateApi(api system.SysApi) (err error) {
	...
	err = global.GSD_DB.Where("id = ?", api.ID).First(&oldA).Error
	...
	if err != nil {
		...
		if err != nil {
			...
			err = global.GSD_DB.Save(&api).Error
		}
	}
	return err
}
...
func (apiService *ApiService) DeleteApisByIds(ids request.IdsReq) (err error) {
	err = global.GSD_DB.Delete(&[]system.SysApi{}, "id in ?", ids.Ids).Error
	return err
}

func (apiService *ApiService) DeleteApiByIds(ids []string) (err error) {
	return global.GSD_DB.Delete(system.SysApi{}, ids).Error
}
