...
var apis = []system.SysApi{
	...
	{global.GSD_MODEL{ID: 38, CreatedAt: time.Now(), UpdatedAt: time.Now()}, "/user/setSelfInfo", "设置当前用户信息（必选）", "user", "PUT"},
	{global.GSD_MODEL{ID: 39, CreatedAt: time.Now(), UpdatedAt: time.Now()}, "/api/deleteApisByIds", "批量删除api", "api", "DELETE"},
	{global.GSD_MODEL{ID: 40, CreatedAt: time.Now(), UpdatedAt: time.Now()}, "/user/setUserAuthorities", "设置权限组", "user", "POST"},
	{global.GSD_MODEL{ID: 41, CreatedAt: time.Now(), UpdatedAt: time.Now()}, "/user/getUserInfo", "获取自身信息（必选）", "user", "GET"},
	{global.GSD_MODEL{ID: 42, CreatedAt: time.Now(), UpdatedAt: time.Now()}, "/department/addDept", "新增部门（必选）", "department", "POST"},
	{global.GSD_MODEL{ID: 43, CreatedAt: time.Now(), UpdatedAt: time.Now()}, "/department/deleteDept", "删除部门（必选）", "department", "POST"},
	{global.GSD_MODEL{ID: 44, CreatedAt: time.Now(), UpdatedAt: time.Now()}, "/department/updateDept", "更新部门（必选）", "department", "POST"},
	{global.GSD_MODEL{ID: 45, CreatedAt: time.Now(), UpdatedAt: time.Now()}, "/department/lists", "查询部门列表（必选）", "department", "POST"},
	{global.GSD_MODEL{ID: 46, CreatedAt: time.Now(), UpdatedAt: time.Now()}, "/department/id", "根据parentID查询部门（必选）", "department", "POST"},
	{global.GSD_MODEL{ID: 47, CreatedAt: time.Now(), UpdatedAt: time.Now()}, "/user/importExcel", "导出数据（必选）", "user", "POST"},
	{global.GSD_MODEL{ID: 48, CreatedAt: time.Now(), UpdatedAt: time.Now()}, "/user/loadExcel", "加载用户数据（必选）", "user", "GET"},
	{global.GSD_MODEL{ID: 49, CreatedAt: time.Now(), UpdatedAt: time.Now()}, "/user/exportExcel", "导出用户数据（必选）", "user", "POST"},
	{global.GSD_MODEL{ID: 50, CreatedAt: time.Now(), UpdatedAt: time.Now()}, "/user/downloadTemplate", "下载模板数据（必选）", "user", "GET"},
	{global.GSD_MODEL{ID: 51, CreatedAt: time.Now(), UpdatedAt: time.Now()}, "/system/getServerInfo", "获取服务器信息", "system", "POST"},
	{global.GSD_MODEL{ID: 52, CreatedAt: time.Now(), UpdatedAt: time.Now()}, "/system/getSystemConfig", "获取配置文件内容", "system", "POST"},
	{global.GSD_MODEL{ID: 53, CreatedAt: time.Now(), UpdatedAt: time.Now()}, "/system/setSystemConfig", "设置配置文件内容", "system", "POST"},
	{global.GSD_MODEL{ID: 54, CreatedAt: time.Now(), UpdatedAt: time.Now()}, "/user/getUserByAuthority", "根据角色id获取用户信息", "user", "POST"},
	{global.GSD_MODEL{ID: 55, CreatedAt: time.Now(), UpdatedAt: time.Now()}, "/department/users", "根据部门获取子部门和该部门下的用户", "department", "POST"},
}
